 ...
 *
 */
public class Get_Sample_Result {

	private HashMap<Integer, Integer> sample_map = null;
	public static void main(String[] args) throws Exception {
		Get_Sample_Result contrast_2 = new Get_Sample_Result();
		contrast_2.init2("E:\\2014query\\检索结果-序列化结果");
		contrast_2.init_all("E:\\2014query\\DPH_1.res.index.adhoc", "E:\\2014query\\result\\全局-检索结果", "E:\\2014query\\result\\全局-自定义");
