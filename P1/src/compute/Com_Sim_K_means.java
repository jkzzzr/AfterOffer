...
public class Com_Sim_K_means {
	...
	private double sim(Integer in1, Integer in2){
		Base s1 = allDocs.get(in1);
		Base s2 = allDocs.get(in2);
		double result = sim(s1, s2);
		return result;
	}
	private double sim(Base s1 , Base s2){
