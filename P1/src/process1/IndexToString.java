...
public class IndexToString {
	...
	public static int number11 = 10;
	public static String inputPath = "E:\\final--LDA\\lda.cosin."
			+ number11
			+ ".choose.mmr";
	public static String outputPath = "E:\\final--LDA\\lda.cosin."
			+ number11
			+ ".choose.mmr.string";
